...
public class SavedErrors {
    ...
    private void setErrors(){
        errors.put("WRONG_NAME", "Must contains first name and last name in the format: \'Mike Tyson\', first name and last name must consist of only letters with length at least 4 letters and a single free space between them!");
        errors.put("WRONG_ADDRESS","Address must consists of street and number of the street in format: \'Boulevarden 101\', street must contains only letters with length at least 4 and the number must be positive!");
